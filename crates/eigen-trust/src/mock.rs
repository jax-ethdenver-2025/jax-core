...
impl MockTrustFetcher {
    pub fn new() -> Self {
        ...
        let mock_trust = vec![
            ...
            (0, 1, 1.0), (0, 2, 0.5), (0, 3, 0.0),
            (1, 0, 0.75), (1, 2, 1.0), (1, 3, 0.25),
            (2, 0, 0.25), (2, 1, 0.5), (2, 3, 1.0),
            (3, 0, 0.5), (3, 1, 0.25), (3, 2, 0.5),
            // Extended network
            (4, 0, 0.8), (4, 1, 0.2), (4, 5, 1.0),
            (5, 4, 0.9), (5, 6, 0.7),
            (6, 5, 0.8), (6, 7, 0.6),
            (7, 6, 0.5), (7, 0, 0.3),
        ];
    ...
    async fn fetch_trust(&self, i: &usize, j: &usize) -> Result<f64> {
        if let Some(trust_map) = self.mock_trust.iter().find(|&&(peer_i, peer_j, _)| peer_i == *i && peer_j == *j) {
            Ok(trust_map.2)
        } else {
